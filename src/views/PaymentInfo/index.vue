            ...
            <v-card-text>
              <v-row align="center" class="d-flex">
                <v-col class="d-flex">
                  ...
                  <span
                    class="text-h5 align-self-center text-medium-emphasis ml-5"
                    >Xe siêu sang</span
                  >
                </v-col>
              </v-row>
              <v-row
                align="center"
                class="d-flex mt-3 align-self-center text-h6"
              >
                <v-col cols="4">
              ...
              <v-row
                align="center"
                class="d-flex mt-3 align-self-center text-h5"
              >
                <v-col cols="4">
